<template>
    <div id="pokemon-list" class="pokemon-list">
        ...
        <div class="pokemon-list__search-input">
            <input class="pokemon-list__search-input-el" type="text" v-model="search" placeholder="Buscar pokemon">
        </div>
        ...
        <h3 class="u-text-center" v-if="filteredPokemons.length === 0">"No tenemos resultado para {{this.search}}"</h3>
